...
import tech.deplant.jacki.frtest.unit.AbiTests;
...
public class TypeConversionTests {
	...
	@Test
	public void bigint_passed_to_uint128_input_equals_to_hex() throws JsonProcessingException, TvmSdkException {
	...
	@Test
	public void bigdec_passed_to_uint128_input_equals_to_hex() throws JsonProcessingException, TvmSdkException {
		Map<String,Object> converted = SafeMultisigWalletTemplate
				.DEFAULT_ABI()
				.convertFunctionInputs("sendTransaction",
	...
	@Test
	public void hex_passed_to_uint128_output_equals_to_bigint() throws JsonProcessingException, TvmSdkException {
	...
	@Test
	public void str_passed_to_addr_output_equals_to_str() throws JsonProcessingException, TvmSdkException {
		Map<String,Object> converted = TIP3TokenWalletTemplate
				.DEFAULT_ABI()
