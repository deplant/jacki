...
public class TIP3TokenWalletContract extends AbstractContract {
  public TIP3TokenWalletContract(int contextId, String address) throws JsonProcessingException {
    super(contextId,address,DEFAULT_ABI(),Credentials.NONE);
  }

  public TIP3TokenWalletContract(int contextId, String address, ContractAbi abi) {
    super(contextId,address,abi,Credentials.NONE);
  }

  public TIP3TokenWalletContract(int contextId, String address, Credentials credentials) throws
  ...
  public FunctionHandle<Void> destroy(Address remainingGasTo) {
    ...
    return new FunctionHandle<Void>(Void.class, contextId(), address(), abi(), credentials(), "destroy", params, null);
  }
  ...
  public FunctionHandle<Void> burnByRoot(BigInteger amount, Address remainingGasTo,
    ...
    Map<String, Object> params = Map.of("amount", amount, 
        ...
        "payload", payload);
    return new FunctionHandle<Void>(Void.class, contextId(), address(), abi(), credentials(), "burnByRoot", params, null);
  }
  ...
  public FunctionHandle<ResultOfBalance> balance() {
    Map<String, Object> params = Map.of("answerId", 0);
    return new FunctionHandle<ResultOfBalance>(ResultOfBalance.class, contextId(), address(), abi(), credentials(), "balance", params, null);
  }
  ...
  public FunctionHandle<ResultOfRoot> root() {
    Map<String, Object> params = Map.of("answerId", 0);
    return new FunctionHandle<ResultOfRoot>(ResultOfRoot.class, contextId(), address(), abi(), credentials(), "root", params, null);
  }
  ...
  public FunctionHandle<Void> transferToWallet(BigInteger amount, Address recipientTokenWallet,
    ...
    Map<String, Object> params = Map.of("amount", amount, 
        ...
        "notify", notify, 
        "payload", payload);
    return new FunctionHandle<Void>(Void.class, contextId(), address(), abi(), credentials(), "transferToWallet", params, null);
  }
  ...
  public FunctionHandle<Void> acceptMint(BigInteger amount, Address remainingGasTo, Boolean notify,
    ...
    Map<String, Object> params = Map.of("amount", amount, 
        ...
        "notify", notify, 
        "payload", payload);
    return new FunctionHandle<Void>(Void.class, contextId(), address(), abi(), credentials(), "acceptMint", params, null);
  }
