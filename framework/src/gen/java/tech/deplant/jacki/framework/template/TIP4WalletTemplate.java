...
import tech.deplant.jacki.framework.contract.tip4.TIP4WalletContract;
...
public record TIP4WalletTemplate(ContractAbi abi, Tvc tvc) implements Template {
  ...
  public DeployHandle<TIP4WalletContract> prepareDeploy(int contextId, int workchainId,
      Credentials credentials, BigInteger _randomNonce) {
    Map<String, Object> initialDataFields = Map.of("_randomNonce", _randomNonce);
    Map<String, Object> params = Map.of();
    return new DeployHandle<TIP4WalletContract>(TIP4WalletContract.class, contextId, abi(), tvc(), workchainId, credentials, initialDataFields, params, null);
  }
}
