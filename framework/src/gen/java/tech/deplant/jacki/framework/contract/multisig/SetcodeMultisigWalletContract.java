...
/**
 * Java wrapper class for usage of <strong>SetcodeMultisigWalletContract</strong> contract for Everscale blockchain.
 */
public class SetcodeMultisigWalletContract extends MultisigContract {
  public SetcodeMultisigWalletContract(int contextId, String address) throws
      JsonProcessingException {
    super(contextId,address,DEFAULT_ABI(),Credentials.NONE);
  }

  public SetcodeMultisigWalletContract(int contextId, String address, ContractAbi abi) {
    super(contextId,address,abi,Credentials.NONE);
  }

  public SetcodeMultisigWalletContract(int contextId, String address, Credentials credentials)
