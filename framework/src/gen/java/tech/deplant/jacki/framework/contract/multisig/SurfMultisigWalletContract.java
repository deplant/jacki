...
/**
 * Java wrapper class for usage of <strong>SurfMultisigWalletContract</strong> contract for Everscale blockchain.
 */
public class SurfMultisigWalletContract extends MultisigContract {
  public SurfMultisigWalletContract(int contextId, String address) throws JsonProcessingException {
    super(contextId,address,DEFAULT_ABI(),Credentials.NONE);
  }

  public SurfMultisigWalletContract(int contextId, String address, ContractAbi abi) {
    super(contextId,address,abi,Credentials.NONE);
  }

  public SurfMultisigWalletContract(int contextId, String address, Credentials credentials) throws
