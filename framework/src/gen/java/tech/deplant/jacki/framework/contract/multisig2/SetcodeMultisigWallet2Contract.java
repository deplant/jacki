...
/**
 * Java wrapper class for usage of <strong>SetcodeMultisigWallet2Contract</strong> contract for Everscale blockchain.
 */
public class SetcodeMultisigWallet2Contract extends MultisigContract2 {
  public SetcodeMultisigWallet2Contract(int contextId, String address) throws
      JsonProcessingException {
    super(contextId,address,DEFAULT_ABI(),Credentials.NONE);
  }

  public SetcodeMultisigWallet2Contract(int contextId, String address, ContractAbi abi) {
    super(contextId,address,abi,Credentials.NONE);
  }

  public SetcodeMultisigWallet2Contract(int contextId, String address, Credentials credentials)
