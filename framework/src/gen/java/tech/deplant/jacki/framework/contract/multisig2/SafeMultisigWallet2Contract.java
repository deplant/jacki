...
public class SafeMultisigWallet2Contract extends MultisigContract2 {
  public SafeMultisigWallet2Contract(int contextId, String address) throws JsonProcessingException {
    super(contextId,address,DEFAULT_ABI(),Credentials.NONE);
  }

  public SafeMultisigWallet2Contract(int contextId, String address, ContractAbi abi) {
    super(contextId,address,abi,Credentials.NONE);
  }

  public SafeMultisigWallet2Contract(int contextId, String address, Credentials credentials) throws
