...
import tech.deplant.jacki.framework.artifact.*;
...
import static tech.deplant.jacki.framework.LogUtils.error;
...
public record LocalConfig(Artifact<String, String> artifact,
	...
	public Template compileTemplate(String filename,
	                                String contractName) throws JsonProcessingException, TvmSdkException {
	...
	public Template compileTemplate(String sourcePath,
	                                ...
	                                String filename,
	                                String contractName,
	                                String libsPath) throws JsonProcessingException, TvmSdkException {
		...
		if (compilerResult == 0) {
			...
			throw new TvmSdkException(new TvmSdkException.ErrorResult(-600,
