...
/*		Map<String, Object> parameters = Map.of("sdk", sdk,
	 ...
	 */
	default BigInteger accountBalance() throws TvmSdkException {
	 ...
	 * @throws TvmSdkException the ever sdk exception
	 */
	default Account account() throws TvmSdkException {
...
//	}
	 ...
	 * @throws TvmSdkException the ever sdk exception
	 */
	default Abi.DecodedMessageBody decodeMessageBoc(TvmCell messageBoc) throws TvmSdkException {
		return TvmSdk.await(Abi.decodeMessage(contextId(), abi().ABI(), messageBoc.cellBoc(), false, null, null));
	}
