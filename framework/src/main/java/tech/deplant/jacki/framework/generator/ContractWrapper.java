package tech.deplant.jacki.framework.generator;
...
import tech.deplant.jacki.binding.generator.ParserUtils;
...
public class ContractWrapper {
	...
	private static TypeName typeSwitch(String abiTypeString) throws TvmSdkException {
	...
	private static TypeName toTypeName(String abiTypeString) throws TvmSdkException {
	 ...
	 */
	public static void generateFromConfig(String resourcePath) throws IOException, TvmSdkException {
	...
	public static void generate(Abi.AbiContract abi,
	                            ...
	                            String[] superInterfaces) throws IOException, TvmSdkException {
