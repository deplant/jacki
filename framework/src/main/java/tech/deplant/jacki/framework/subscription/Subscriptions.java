...
public interface Subscriptions {
	...
	class Builder {
		 ...
		 */
		private SubscriptionHandle subscribe(int contextId) throws TvmSdkException {
			...
			subscription.handle = TvmSdk.await(Net.subscribe(contextId,
		...
		public SubscriptionHandle subscribeUntilCancel(int contextId) throws TvmSdkException {
			this.hasUnsubsribeCondition = false;
			return subscribe(contextId);
		}

		public SubscriptionHandle subscribeUntilFirst(int contextId) throws TvmSdkException {
		...
		public SubscriptionHandle subscribeUntilCondition(int contextId,
		                                             Predicate<JsonNode> unsubscribeCondition) throws TvmSdkException {
			this.hasUnsubsribeCondition = true;
