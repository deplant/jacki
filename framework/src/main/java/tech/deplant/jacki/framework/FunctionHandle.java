...
import tech.deplant.jacki.framework.contract.multisig2.MultisigContract2;
...
import static tech.deplant.jacki.framework.LogUtils.*;
...
public record FunctionHandle<RETURN>(Class<RETURN> clazz,
	 ...
	 */
	public Abi.CallSet toCallSet() throws TvmSdkException {
	 ...
	 * @throws TvmSdkException the ever sdk exception
	 */
	public RETURN toOutput(JsonNode outputMap) throws TvmSdkException {
	 ...
	 * @throws TvmSdkException the ever sdk exception
	 */
	public TvmCell toPayload() throws TvmSdkException {
	 ...
	 * @throws TvmSdkException the ever sdk exception
	 */
	public TvmCell toPayload(boolean isInternal) throws TvmSdkException {
		return new TvmCell(TvmSdk.await(Abi.encodeMessageBody(contract().contextId(),
	 ...
	 * @throws TvmSdkException the ever sdk exception
	 */
	public JsonNode getAsMap() throws TvmSdkException {
		Map<String, Object> filter = new HashMap<>();
		filter.put("id", new Account.GraphQLFilter.In(new String[]{contract().address().makeAddrStd()}));
		Net.ResultOfQueryCollection result = TvmSdk.await(Net.queryCollection(contract().contextId(),
		                                                                       "accounts",
		                                                                       ...
		                                                                       null,
		                                                                       null));
		Abi.ResultOfEncodeMessage msg = TvmSdk.await(Abi.encodeMessage(contract().contextId(),
		                                                                contract().abi()
		...
		for (var map : result.result()) {
			...
			return Optional.ofNullable(TvmSdk.await(Tvm.runTvm(contract().contextId(),
			                                                    msg.message(),
			                                                    boc,
			                                                    null,
			                                                    contract().abi().ABI(),
	 ...
	 * @throws TvmSdkException the ever sdk exception
	 */
	public RETURN get() throws TvmSdkException {
	 ...
	 * @throws TvmSdkException the ever sdk exception
	 */
	public RETURN getLocal(String boc) throws TvmSdkException {
	 ...
	 * @throws TvmSdkException the ever sdk exception
	 */
	public JsonNode getLocalAsMap(String boc) throws TvmSdkException {
		Abi.ResultOfEncodeMessage msg = TvmSdk.await(Abi.encodeMessage(contract().contextId(),
		                                                                contract().abi()
		                                                                          .functionCallABI(functionName()),
		                                                                contract().address().makeAddrStd(),
	...
	public JsonNode callLocalAsMap(String boc,
	                               ...
	                               boolean unlimitedBalance) throws TvmSdkException {
		Abi.ResultOfEncodeMessage msg = TvmSdk.await(Abi.encodeMessage(contract().contextId(),
		                                                                contract().abi()
		                                                                          .functionCallABI(functionName()),
		                                                                contract().address().makeAddrStd(),
		                                                                ...
		                                                                null,
		                                                                getSignature()));
		return Optional.ofNullable(TvmSdk.await(Tvm.runExecutor(contract().contextId(),
		                                                         msg.message(),
	 ...
	 * @throws TvmSdkException the ever sdk exception
	 */
	public JsonNode callAsMap() throws TvmSdkException {
		var resultOfProcess = processExternalCall();
		var balanceDeltaStr = Hexes.asBigDec(resultOfProcess.transaction().get("balance_delta").asText(), 9);
	 ...
	 * @throws TvmSdkException the ever sdk exception
	 */
	public RETURN call() throws TvmSdkException {
	...
	public ResultOfTree<JsonNode> callTreeAsMap(boolean throwOnTreeError,
	                                            ContractAbi... otherAbisForDecode) throws TvmSdkException {
		...
		var debugOutResult = TvmSdk.await(Net.queryTransactionTree(contract().contextId(),
		                                                            msgId,
		                                                            finalABIArray,
		...
		for (Net.TransactionNode tr : debugOutResult.transactions()) {
			...
			Supplier<String> lazyFormatLogMessage = () -> String.format(LogUtils.CALL_LOG_BLOCK,
			                                                            ...
			                                                            Hexes.asBigDec(msg.value(), 9)
			                                                                   .toPlainString(),
			                                                            LogUtils.destOfMessage(msg),
			                                                            tr.exitCode(),
			                                                            LogUtils.nameOfMessage(msg),
			                                                            Hexes.asBigDec(tr.totalFees(), 9)
			                                                                   .toPlainString(),
			...
			if (tr.aborted() && throwOnTreeError) {
				...
				if (Objs.isNull(tr.exitCode())) {
					throw new TvmSdkException(new TvmSdkException.ErrorResult(-404, tr.toString()),
					                           "ABORTED! Exit code: -404. Target contract " +
					                           LogUtils.destOfMessage(msg) + " is not deployed!");
				} else {
					throw new TvmSdkException(new TvmSdkException.ErrorResult(tr.exitCode(), tr.toString()),
	...
	public JsonNode sendFromAsMap(MultisigContract2 sender,
	                              BigInteger value,
	                              boolean bounce,
	                              MessageFlag flag) throws TvmSdkException {
	 ...
	 * @throws TvmSdkException the ever sdk exception
	 */
	public JsonNode sendFromAsMap(MultisigContract sender, BigInteger value) throws TvmSdkException {
	 ...
	 * @throws TvmSdkException the ever sdk exception
	 */
	public RETURN sendFrom(MultisigContract sender, BigInteger value) throws TvmSdkException {
	...
	public ResultOfTree<JsonNode> sendFromTreeAsMap(MultisigContract sender,
		...
		try {
			...
			throw new TvmSdkException(new TvmSdkException.ErrorResult(-500, e.getMessage()));
		}
	}
	...
	private Long getSignature() {
		return switch (TvmSdk.contextConfig(contract().contextId())) {
			case null -> null;
	...
	private Processing.ResultOfProcessMessage processExternalCall() throws TvmSdkException {
		return TvmSdk.await(Processing.processMessage(contract().contextId(),
		                                               contract().abi().functionCallABI(functionName()),
		                                               contract().address().makeAddrStd(),
		                                               null,
		                                               toCallSet(),
