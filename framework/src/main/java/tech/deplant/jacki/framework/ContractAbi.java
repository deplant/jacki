...
import tech.deplant.jacki.framework.datatype.SolStruct;
...
public record ContractAbi(Abi.AbiContract abiContract) {
	 ...
	 */
	public String functionId(int sdk, String name) throws TvmSdkException {
		return Uint.of(32, TvmSdk.await(Abi.calcFunctionId(sdk, ABI(), name, false)).functionId()).toABI();
	}
	...
	public Map<String, Object> convertFunctionOutputs(String functionName,
	                                                  Map<String, Object> functionOutputs) throws TvmSdkException {
		var functionParams = Arrays.stream(functions())
		                           .filter(function -> functionName.equals(function.name()))
		                           .findAny()
		                           .orElseThrow(() -> new TvmSdkException(new TvmSdkException.ErrorResult(-303,
		                                                                                                    "No such function: " +
		                                                                                                    functionName +
		                                                                                                    " in ABI"),
		                                                                   new Exception()))
	...
	public Map<String, Object> convertFunctionInputs(String functionName,
	                                                 Map<String, Object> functionInputs) throws TvmSdkException {
		var functionParams = Arrays.stream(functions())
		                           .filter(function -> functionName.equals(function.name()))
		                           .findAny()
		                           .orElseThrow(() -> new TvmSdkException(new TvmSdkException.ErrorResult(-303,
	 ...
	 * @throws TvmSdkException the ever sdk exception
	 */
	public Map<String, Object> convertInitDataInputs(Map<String, Object> initDataInputs) throws TvmSdkException {
