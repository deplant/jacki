...
public record SolStruct(Abi.AbiParam[] abiParams,
	 ...
	 */
	public static Object serializeInputTree(Abi.AbiParam param, Object inputValue) throws TvmSdkException {
	 ...
	 * @throws TvmSdkException the ever sdk exception
	 */
	public static Object serializeOutputTree(Abi.AbiParam param, Object outputValue) throws TvmSdkException {
		...
		if (rootIsMap) {
			...
			if (rootDetails.prefix().equals(AbiTypePrefix.TUPLE)) {
				// tuple = Map<String,Object> from components
				//TODO This cast is wrong its, array of maps
