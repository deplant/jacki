...
import tech.deplant.jacki.framework.subscription.Subscriptions;
...
//	}
	...
	public Subscriptions.Builder subscribeOnIncomingMessages(String resultFields,
	                                                         Consumer<JsonNode> subscribeEventConsumer) throws TvmSdkException {
	 ...
	 * @throws TvmSdkException the ever sdk exception
	 */
	public Subscriptions.Builder subscribeOnTransactions(Consumer<JsonNode> subscribeEventConsumer, String... resultFields) throws TvmSdkException {
		return Subscriptions.onAccounts(resultFields)
		                    .addFilterOnSubscription("id: { eq: \"%s\" }".formatted(address().toString()))
		                    .addCallbackConsumer(subscribeEventConsumer);
	}
