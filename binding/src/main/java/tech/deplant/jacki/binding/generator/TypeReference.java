package tech.deplant.jacki.binding.generator;

import com.fasterxml.jackson.databind.JsonNode;
import tech.deplant.commons.Strings;
import tech.deplant.jacki.binding.SubscribeEvent;
import tech.deplant.jacki.binding.ffi.TvmSdkContext;
import tech.deplant.javapoet.*;
import tech.deplant.jacki.binding.generator.jtype.SdkObject;
import tech.deplant.jacki.binding.generator.reference.*;
	...
	public TypeName toTypeName() {
		...
		if (isRef()) {
			...
			typeName = switch (name()) {
				...
				case "ClientContext" -> ClassName.get(TvmSdkContext.class);
