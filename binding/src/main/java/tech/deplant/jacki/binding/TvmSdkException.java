 ...
 * @since 1.5
 */
public class TvmSdkException extends Exception {
	 ...
	 */
	public TvmSdkException(ErrorResult errorResponse) {
		super();
	 ...
	 */
	public TvmSdkException(ErrorResult errorResponse, String message) {
		super(message);
		this.errorResponse = errorResponse;
	}
	 ...
	 */
	public TvmSdkException(ErrorResult errorResponse, String message, Throwable cause) {
		super(message, cause);
		this.errorResponse = errorResponse;
	}
	 ...
	 *              {@link #getCause()} method)
	 */
	public TvmSdkException(ErrorResult errorResponse, Throwable cause) {
		super(cause);
		this.errorResponse = errorResponse;
	}
