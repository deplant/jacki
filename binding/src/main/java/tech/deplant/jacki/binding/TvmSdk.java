...
import tech.deplant.jacki.binding.ffi.TvmSdkContext;
import tech.deplant.jacki.binding.ffi.NativeMethods;
import tech.deplant.jacki.binding.loader.DefaultLoader;
import tech.deplant.jacki.binding.loader.DefaultLoaderContext;
...
public class TvmSdk {
	...
	private final static System.Logger logger = System.getLogger(TvmSdk.class.getName());
	private final static Map<Integer, TvmSdkContext> contexts = new ConcurrentHashMap<>();
	/**
	...
	public static <P> CompletableFuture<Void> asyncVoid(final int contextId,
	                                                    ...
	                                                    final P functionInputs) throws TvmSdkException {
	...
	public static <T, P> CompletableFuture<T> async(final int contextId,
	                                                ...
	                                                final Class<T> outputClass) throws TvmSdkException {
	...
	public static <T, P> CompletableFuture<T> asyncCallback(final int contextId,
	                                                        ...
	                                                        Consumer<JsonNode> eventConsumer) throws TvmSdkException {
	...
	public static <T, P> CompletableFuture<T> asyncAppObject(final int contextId,
	                                                         ...
	                                                         final P functionInputs,
	                                                         final Class<T> outputClass,
	                                                         AppObject appObject) throws TvmSdkException {
	 ...
	 * @throws TvmSdkException the ever sdk exception
	 */
	public static int createDefault() throws TvmSdkException {
	 ...
	 * @throws TvmSdkException the ever sdk exception
	 */
	public static int createWithEndpoint(String endpoint) throws TvmSdkException {
	 ...
	 * @throws TvmSdkException the ever sdk exception
	 */
	public static int createWithConfig(Client.ClientConfig config) throws TvmSdkException {
		...
		try {
			...
			try {
				...
				if (contextId.isEmpty() || contextId.get() < 1) {
					...
					throw new TvmSdkException(new TvmSdkException.ErrorResult(-502,
					                                                            "FUNC:sdk.tc_create_context result is empty!"));
				}
				int ctxId = contextId.get();
				contexts.put(ctxId, new TvmSdkContext(ctxId, mergedConfig));
				...
				logger.log(System.Logger.Level.ERROR,
				           () -> "FUNC:sdk.tc_create_context request deserialization failed! Exception: %s Result: %s".formatted(
						           e,
						           finalResultString));
				throw new TvmSdkException(new TvmSdkException.ErrorResult(-501,
	 ...
	 * @throws TvmSdkException the ever sdk exception
	 */
	public static int createWithJson(String configJson) throws TvmSdkException {
		try {
	...
	public static Processing.ResultOfProcessMessage sendExternalMessage(int contextId,
	                                                                    ...
	                                                                    String stateInit,
	                                                                    String messageBody,
	                                                                    String optionalSrcAddress) throws TvmSdkException {
		var message = TvmSdk.await(Boc.encodeExternalInMessage(contextId,
		                                                        optionalSrcAddress,
		                                                        dstAddress,
		                                                        stateInit,
		                                                        messageBody,
		...
		var request = TvmSdk.await(Processing.sendMessage(contextId, message, abi, false, null));

		return TvmSdk.await(Processing.waitForTransaction(contextId,
		                                                   abi,
		                                                   message,
	 ...
	 * @throws TvmSdkException the ever sdk exception
	 */
	public static <T> T await(CompletableFuture<T> functionOutputs) throws TvmSdkException {
		try {
			...
			throw new TvmSdkException(new TvmSdkException.ErrorResult(-400, "EVER-SDK call interrupted!"),
			                           ex3.getCause());
		} catch (TimeoutException ex4) {
			logger.log(System.Logger.Level.ERROR,
			           () -> "EVER-SDK Call expired on Timeout! %s".formatted(ex4.toString()));
			throw new TvmSdkException(new TvmSdkException.ErrorResult(-408, "EVER-SDK call expired on Timeout!"),
			                           ex4.getCause());
		} catch (ExecutionException e) {
			if (e.getCause() instanceof TvmSdkException everEx) {
				throw everEx;
			} else {
				logger.log(System.Logger.Level.ERROR,
				           () -> "EVER-SDK Call unknown execution exception! %s".formatted(e.toString()));
				throw new TvmSdkException(new TvmSdkException.ErrorResult(-500, "EVER-SDK call expired on Timeout!"),
				                           e.getCause());
			}
		}
	}
...
//abi
		 ...
		 * @throws TvmSdkException the ever sdk exception
		 */
		public int build() throws TvmSdkException {
