...
public final class Tvm {
  ...
  public static CompletableFuture<Tvm.ResultOfRunExecutor> runExecutor(int ctxId, String message,
      ...
      Boolean skipTransactionCheck, Boc.BocCacheType bocCache, Boolean returnUpdatedAccount) throws
          TvmSdkException {
    return TvmSdk.async(ctxId, "tvm.run_executor", new Tvm.ParamsOfRunExecutor(message, account, executionOptions, abi, skipTransactionCheck, bocCache, returnUpdatedAccount), Tvm.ResultOfRunExecutor.class);
  }
  ...
  public static CompletableFuture<Tvm.ResultOfRunTvm> runTvm(int ctxId, String message,
      ...
      Boolean returnUpdatedAccount) throws TvmSdkException {
    return TvmSdk.async(ctxId, "tvm.run_tvm", new Tvm.ParamsOfRunTvm(message, account, executionOptions, abi, bocCache, returnUpdatedAccount), Tvm.ResultOfRunTvm.class);
  }
  ...
  public static CompletableFuture<Tvm.ResultOfRunGet> runGet(int ctxId, String account,
      ...
      Boolean tupleListAsArray) throws TvmSdkException {
    return TvmSdk.async(ctxId, "tvm.run_get", new Tvm.ParamsOfRunGet(account, functionName, input, executionOptions, tupleListAsArray), Tvm.ResultOfRunGet.class);
  }
