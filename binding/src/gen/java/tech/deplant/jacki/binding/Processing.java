...
public final class Processing {
  ...
  public static void monitorMessages(int ctxId, String queue,
      Processing.MessageMonitoringParams[] messages) throws TvmSdkException {
    TvmSdk.asyncVoid(ctxId, "processing.monitor_messages", new Processing.ParamsOfMonitorMessages(queue, messages));
  }
  ...
  public static CompletableFuture<Processing.MonitoringQueueInfo> getMonitorInfo(int ctxId,
      String queue) throws TvmSdkException {
    return TvmSdk.async(ctxId, "processing.get_monitor_info", new Processing.ParamsOfGetMonitorInfo(queue), Processing.MonitoringQueueInfo.class);
  }
  ...
  public static CompletableFuture<Processing.ResultOfFetchNextMonitorResults> fetchNextMonitorResults(
      int ctxId, String queue, Processing.MonitorFetchWaitMode waitMode) throws TvmSdkException {
    return TvmSdk.async(ctxId, "processing.fetch_next_monitor_results", new Processing.ParamsOfFetchNextMonitorResults(queue, waitMode), Processing.ResultOfFetchNextMonitorResults.class);
  }
   ...
   * @param queue  Name of the monitoring queue.
   */
  public static void cancelMonitor(int ctxId, String queue) throws TvmSdkException {
    TvmSdk.asyncVoid(ctxId, "processing.cancel_monitor", new Processing.ParamsOfCancelMonitor(queue));
  }
  ...
  public static CompletableFuture<Processing.ResultOfSendMessages> sendMessages(int ctxId,
      Processing.MessageSendingParams[] messages, String monitorQueue) throws TvmSdkException {
    return TvmSdk.async(ctxId, "processing.send_messages", new Processing.ParamsOfSendMessages(messages, monitorQueue), Processing.ResultOfSendMessages.class);
  }
  ...
  public static CompletableFuture<Processing.ResultOfSendMessage> sendMessage(int ctxId,
      String message, Abi.ABI abi, Boolean sendEvents, Consumer<JsonNode> callback) throws
          TvmSdkException {
    return TvmSdk.asyncCallback(ctxId, "processing.send_message", new Processing.ParamsOfSendMessage(message, abi, sendEvents), Processing.ResultOfSendMessage.class, callback);
  }
  ...
  public static CompletableFuture<Processing.ResultOfProcessMessage> waitForTransaction(int ctxId,
      ...
      String[] sendingEndpoints, Consumer<JsonNode> callback) throws TvmSdkException {
    return TvmSdk.asyncCallback(ctxId, "processing.wait_for_transaction", new Processing.ParamsOfWaitForTransaction(abi, message, shardBlockId, sendEvents, sendingEndpoints), Processing.ResultOfProcessMessage.class, callback);
  }
  ...
  public static CompletableFuture<Processing.ResultOfProcessMessage> processMessage(int ctxId,
      ...
      Integer processingTryIndex, Long signatureId, Boolean sendEvents) throws TvmSdkException {
    return TvmSdk.async(ctxId, "processing.process_message", new Processing.ParamsOfProcessMessage(new Abi.ParamsOfEncodeMessage(abi, address, deploySet, callSet, signer, processingTryIndex, signatureId), sendEvents), Processing.ResultOfProcessMessage.class);
  }
