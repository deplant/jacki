...
public final class Net {
  ...
  public static CompletableFuture<Net.ResultOfQuery> query(int ctxId, String query,
      JsonNode variables) throws TvmSdkException {
    return TvmSdk.async(ctxId, "net.query", new Net.ParamsOfQuery(query, variables), Net.ResultOfQuery.class);
  }
  ...
  public static CompletableFuture<Net.ResultOfBatchQuery> batchQuery(int ctxId,
      Net.ParamsOfQueryOperation[] operations) throws TvmSdkException {
    return TvmSdk.async(ctxId, "net.batch_query", new Net.ParamsOfBatchQuery(operations), Net.ResultOfBatchQuery.class);
  }
  ...
  public static CompletableFuture<Net.ResultOfQueryCollection> queryCollection(int ctxId,
      String collection, JsonNode filter, String result, Net.OrderBy[] order, Long limit) throws
          TvmSdkException {
    return TvmSdk.async(ctxId, "net.query_collection", new Net.ParamsOfQueryCollection(collection, filter, result, order, limit), Net.ResultOfQueryCollection.class);
  }
  ...
  public static CompletableFuture<Net.ResultOfAggregateCollection> aggregateCollection(int ctxId,
      String collection, JsonNode filter, Net.FieldAggregation[] fields) throws TvmSdkException {
    return TvmSdk.async(ctxId, "net.aggregate_collection", new Net.ParamsOfAggregateCollection(collection, filter, fields), Net.ResultOfAggregateCollection.class);
  }
  ...
  public static CompletableFuture<Net.ResultOfWaitForCollection> waitForCollection(int ctxId,
      String collection, JsonNode filter, String result, Long timeout) throws TvmSdkException {
    return TvmSdk.async(ctxId, "net.wait_for_collection", new Net.ParamsOfWaitForCollection(collection, filter, result, timeout), Net.ResultOfWaitForCollection.class);
  }
  ...
  public static void unsubscribe(int ctxId, Net.ResultOfSubscribeCollection params) throws
          TvmSdkException {
    TvmSdk.asyncVoid(ctxId, "net.unsubscribe", params);
  }
  ...
  public static CompletableFuture<Net.ResultOfSubscribeCollection> subscribeCollection(int ctxId,
      String collection, JsonNode filter, String result, Consumer<JsonNode> callback) throws
          TvmSdkException {
    return TvmSdk.asyncCallback(ctxId, "net.subscribe_collection", new Net.ParamsOfSubscribeCollection(collection, filter, result), Net.ResultOfSubscribeCollection.class, callback);
  }
  ...
  public static CompletableFuture<Net.ResultOfSubscribeCollection> subscribe(int ctxId,
      String subscription, JsonNode variables, Consumer<JsonNode> callback) throws
          TvmSdkException {
    return TvmSdk.asyncCallback(ctxId, "net.subscribe", new Net.ParamsOfSubscribe(subscription, variables), Net.ResultOfSubscribeCollection.class, callback);
  }

  /**
   *  Suspends network module to stop any network activity
   */
  public static void suspend(int ctxId) throws TvmSdkException {
    TvmSdk.asyncVoid(ctxId, "net.suspend", null);
  }

  /**
   *  Resumes network module to enable network activity
   */
  public static void resume(int ctxId) throws TvmSdkException {
    TvmSdk.asyncVoid(ctxId, "net.resume", null);
  }
  ...
  public static CompletableFuture<Net.ResultOfFindLastShardBlock> findLastShardBlock(int ctxId,
      String address) throws TvmSdkException {
    return TvmSdk.async(ctxId, "net.find_last_shard_block", new Net.ParamsOfFindLastShardBlock(address), Net.ResultOfFindLastShardBlock.class);
  }
  ...
  public static CompletableFuture<Net.EndpointsSet> fetchEndpoints(int ctxId) throws
          TvmSdkException {
    return TvmSdk.async(ctxId, "net.fetch_endpoints", null, Net.EndpointsSet.class);
  }

  /**
   *  Sets the list of endpoints to use on reinit
   */
  public static void setEndpoints(int ctxId, Net.EndpointsSet params) throws TvmSdkException {
    TvmSdk.asyncVoid(ctxId, "net.set_endpoints", params);
  }
  ...
  public static CompletableFuture<Net.ResultOfGetEndpoints> getEndpoints(int ctxId) throws
          TvmSdkException {
    return TvmSdk.async(ctxId, "net.get_endpoints", null, Net.ResultOfGetEndpoints.class);
  }
  ...
  public static CompletableFuture<Net.ResultOfQueryCollection> queryCounterparties(int ctxId,
      String account, String result, Long first, String after) throws TvmSdkException {
    return TvmSdk.async(ctxId, "net.query_counterparties", new Net.ParamsOfQueryCounterparties(account, result, first, after), Net.ResultOfQueryCollection.class);
  }
  ...
  public static CompletableFuture<Net.ResultOfQueryTransactionTree> queryTransactionTree(int ctxId,
      String inMsg, Abi.ABI[] abiRegistry, Long timeout, Long transactionMaxCount) throws
          TvmSdkException {
    return TvmSdk.async(ctxId, "net.query_transaction_tree", new Net.ParamsOfQueryTransactionTree(inMsg, abiRegistry, timeout, transactionMaxCount), Net.ResultOfQueryTransactionTree.class);
  }
  ...
  public static CompletableFuture<Net.RegisteredIterator> createBlockIterator(int ctxId,
      Long startTime, Long endTime, String[] shardFilter, String result) throws TvmSdkException {
    return TvmSdk.async(ctxId, "net.create_block_iterator", new Net.ParamsOfCreateBlockIterator(startTime, endTime, shardFilter, result), Net.RegisteredIterator.class);
  }
  ...
  public static CompletableFuture<Net.RegisteredIterator> resumeBlockIterator(int ctxId,
      JsonNode resumeState) throws TvmSdkException {
    return TvmSdk.async(ctxId, "net.resume_block_iterator", new Net.ParamsOfResumeBlockIterator(resumeState), Net.RegisteredIterator.class);
  }
  ...
  public static CompletableFuture<Net.RegisteredIterator> createTransactionIterator(int ctxId,
      ...
      Boolean includeTransfers) throws TvmSdkException {
    return TvmSdk.async(ctxId, "net.create_transaction_iterator", new Net.ParamsOfCreateTransactionIterator(startTime, endTime, shardFilter, accountsFilter, result, includeTransfers), Net.RegisteredIterator.class);
  }
  ...
  public static CompletableFuture<Net.RegisteredIterator> resumeTransactionIterator(int ctxId,
      JsonNode resumeState, String[] accountsFilter) throws TvmSdkException {
    return TvmSdk.async(ctxId, "net.resume_transaction_iterator", new Net.ParamsOfResumeTransactionIterator(resumeState, accountsFilter), Net.RegisteredIterator.class);
  }
  ...
  public static CompletableFuture<Net.ResultOfIteratorNext> iteratorNext(int ctxId, Long iterator,
      Long limit, Boolean returnResumeState) throws TvmSdkException {
    return TvmSdk.async(ctxId, "net.iterator_next", new Net.ParamsOfIteratorNext(iterator, limit, returnResumeState), Net.ResultOfIteratorNext.class);
  }
  ...
  public static void removeIterator(int ctxId, Net.RegisteredIterator params) throws
          TvmSdkException {
    TvmSdk.asyncVoid(ctxId, "net.remove_iterator", params);
  }
  ...
  public static CompletableFuture<Net.ResultOfGetSignatureId> getSignatureId(int ctxId) throws
          TvmSdkException {
    return TvmSdk.async(ctxId, "net.get_signature_id", null, Net.ResultOfGetSignatureId.class);
  }
