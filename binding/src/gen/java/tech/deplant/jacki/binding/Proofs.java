...
public final class Proofs {
   ...
   */
  public static void proofBlockData(int ctxId, JsonNode block) throws TvmSdkException {
    TvmSdk.asyncVoid(ctxId, "proofs.proof_block_data", new Proofs.ParamsOfProofBlockData(block));
  }
   ...
   */
  public static void proofTransactionData(int ctxId, JsonNode transaction) throws TvmSdkException {
    TvmSdk.asyncVoid(ctxId, "proofs.proof_transaction_data", new Proofs.ParamsOfProofTransactionData(transaction));
  }
   ...
   */
  public static void proofMessageData(int ctxId, JsonNode message) throws TvmSdkException {
    TvmSdk.asyncVoid(ctxId, "proofs.proof_message_data", new Proofs.ParamsOfProofMessageData(message));
  }
