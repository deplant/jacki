...
public final class Client {
  ...
  public static CompletableFuture<Client.ResultOfGetApiReference> getApiReference(int ctxId) throws
          TvmSdkException {
    return TvmSdk.async(ctxId, "client.get_api_reference", null, Client.ResultOfGetApiReference.class);
  }
  ...
  public static CompletableFuture<Client.ResultOfVersion> version(int ctxId) throws
          TvmSdkException {
    return TvmSdk.async(ctxId, "client.version", null, Client.ResultOfVersion.class);
  }

  /**
   *  Returns Core Library API reference
   */
  public static CompletableFuture<Client.ClientConfig> config(int ctxId) throws TvmSdkException {
    return TvmSdk.async(ctxId, "client.config", null, Client.ClientConfig.class);
  }
  ...
  public static CompletableFuture<Client.ResultOfBuildInfo> buildInfo(int ctxId) throws
          TvmSdkException {
    return TvmSdk.async(ctxId, "client.build_info", null, Client.ResultOfBuildInfo.class);
  }
  ...
  public static void resolveAppRequest(int ctxId, Long appRequestId, Client.AppRequestResult result)
    ...
    TvmSdk.asyncVoid(ctxId, "client.resolve_app_request", new Client.ParamsOfResolveAppRequest(appRequestId, result));
  }
