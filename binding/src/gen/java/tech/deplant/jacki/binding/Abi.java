...
public final class Abi {
  ...
  public static CompletableFuture<Abi.ResultOfEncodeMessageBody> encodeMessageBody(int ctxId,
      ...
      Integer processingTryIndex, String address, Long signatureId) throws TvmSdkException {
    return TvmSdk.async(ctxId, "abi.encode_message_body", new Abi.ParamsOfEncodeMessageBody(abi, callSet, isInternal, signer, processingTryIndex, address, signatureId), Abi.ResultOfEncodeMessageBody.class);
  }
  ...
  public static CompletableFuture<Abi.ResultOfAttachSignatureToMessageBody> attachSignatureToMessageBody(
      int ctxId, Abi.ABI abi, String publicKey, String message, String signature) throws
          TvmSdkException {
    return TvmSdk.async(ctxId, "abi.attach_signature_to_message_body", new Abi.ParamsOfAttachSignatureToMessageBody(abi, publicKey, message, signature), Abi.ResultOfAttachSignatureToMessageBody.class);
  }
  ...
  public static CompletableFuture<Abi.ResultOfEncodeMessage> encodeMessage(int ctxId, Abi.ABI abi,
      ...
      Integer processingTryIndex, Long signatureId) throws TvmSdkException {
    return TvmSdk.async(ctxId, "abi.encode_message", new Abi.ParamsOfEncodeMessage(abi, address, deploySet, callSet, signer, processingTryIndex, signatureId), Abi.ResultOfEncodeMessage.class);
  }
  ...
  public static CompletableFuture<Abi.ResultOfEncodeInternalMessage> encodeInternalMessage(
      ...
      Abi.CallSet callSet, String value, Boolean bounce, Boolean enableIhr) throws
          TvmSdkException {
    return TvmSdk.async(ctxId, "abi.encode_internal_message", new Abi.ParamsOfEncodeInternalMessage(abi, address, srcAddress, deploySet, callSet, value, bounce, enableIhr), Abi.ResultOfEncodeInternalMessage.class);
  }
  ...
  public static CompletableFuture<Abi.ResultOfAttachSignature> attachSignature(int ctxId,
      Abi.ABI abi, String publicKey, String message, String signature) throws TvmSdkException {
    return TvmSdk.async(ctxId, "abi.attach_signature", new Abi.ParamsOfAttachSignature(abi, publicKey, message, signature), Abi.ResultOfAttachSignature.class);
  }
  ...
  public static CompletableFuture<Abi.DecodedMessageBody> decodeMessage(int ctxId, Abi.ABI abi,
      String message, Boolean allowPartial, String functionName, Abi.DataLayout dataLayout) throws
          TvmSdkException {
    return TvmSdk.async(ctxId, "abi.decode_message", new Abi.ParamsOfDecodeMessage(abi, message, allowPartial, functionName, dataLayout), Abi.DecodedMessageBody.class);
  }
  ...
  public static CompletableFuture<Abi.DecodedMessageBody> decodeMessageBody(int ctxId, Abi.ABI abi,
      ...
      Abi.DataLayout dataLayout) throws TvmSdkException {
    return TvmSdk.async(ctxId, "abi.decode_message_body", new Abi.ParamsOfDecodeMessageBody(abi, body, isInternal, allowPartial, functionName, dataLayout), Abi.DecodedMessageBody.class);
  }
  ...
  public static CompletableFuture<Abi.ResultOfEncodeAccount> encodeAccount(int ctxId,
      ...
      Boc.BocCacheType bocCache) throws TvmSdkException {
    return TvmSdk.async(ctxId, "abi.encode_account", new Abi.ParamsOfEncodeAccount(stateInit, balance, lastTransLt, lastPaid, bocCache), Abi.ResultOfEncodeAccount.class);
  }
  ...
  public static CompletableFuture<Abi.ResultOfDecodeAccountData> decodeAccountData(int ctxId,
      Abi.ABI abi, String data, Boolean allowPartial) throws TvmSdkException {
    return TvmSdk.async(ctxId, "abi.decode_account_data", new Abi.ParamsOfDecodeAccountData(abi, data, allowPartial), Abi.ResultOfDecodeAccountData.class);
  }
  ...
  public static CompletableFuture<Abi.ResultOfUpdateInitialData> updateInitialData(int ctxId,
      ...
      Boc.BocCacheType bocCache) throws TvmSdkException {
    return TvmSdk.async(ctxId, "abi.update_initial_data", new Abi.ParamsOfUpdateInitialData(abi, data, initialData, initialPubkey, bocCache), Abi.ResultOfUpdateInitialData.class);
  }
  ...
  public static CompletableFuture<Abi.ResultOfEncodeInitialData> encodeInitialData(int ctxId,
      Abi.ABI abi, JsonNode initialData, String initialPubkey, Boc.BocCacheType bocCache) throws
          TvmSdkException {
    return TvmSdk.async(ctxId, "abi.encode_initial_data", new Abi.ParamsOfEncodeInitialData(abi, initialData, initialPubkey, bocCache), Abi.ResultOfEncodeInitialData.class);
  }
  ...
  public static CompletableFuture<Abi.ResultOfDecodeInitialData> decodeInitialData(int ctxId,
      Abi.ABI abi, String data, Boolean allowPartial) throws TvmSdkException {
    return TvmSdk.async(ctxId, "abi.decode_initial_data", new Abi.ParamsOfDecodeInitialData(abi, data, allowPartial), Abi.ResultOfDecodeInitialData.class);
  }
  ...
  public static CompletableFuture<Abi.ResultOfDecodeBoc> decodeBoc(int ctxId, Abi.AbiParam[] params,
      String boc, Boolean allowPartial) throws TvmSdkException {
    return TvmSdk.async(ctxId, "abi.decode_boc", new Abi.ParamsOfDecodeBoc(params, boc, allowPartial), Abi.ResultOfDecodeBoc.class);
  }
  ...
  public static CompletableFuture<Abi.ResultOfAbiEncodeBoc> encodeBoc(int ctxId,
      Abi.AbiParam[] params, JsonNode data, Boc.BocCacheType bocCache) throws TvmSdkException {
    return TvmSdk.async(ctxId, "abi.encode_boc", new Abi.ParamsOfAbiEncodeBoc(params, data, bocCache), Abi.ResultOfAbiEncodeBoc.class);
  }
  ...
  public static CompletableFuture<Abi.ResultOfCalcFunctionId> calcFunctionId(int ctxId, Abi.ABI abi,
      String functionName, Boolean output) throws TvmSdkException {
    return TvmSdk.async(ctxId, "abi.calc_function_id", new Abi.ParamsOfCalcFunctionId(abi, functionName, output), Abi.ResultOfCalcFunctionId.class);
  }
  ...
  public static CompletableFuture<Abi.ResultOfGetSignatureData> getSignatureData(int ctxId,
      Abi.ABI abi, String message, Long signatureId) throws TvmSdkException {
    return TvmSdk.async(ctxId, "abi.get_signature_data", new Abi.ParamsOfGetSignatureData(abi, message, signatureId), Abi.ResultOfGetSignatureData.class);
  }
