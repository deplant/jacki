...
public final class Utils {
  ...
  public static CompletableFuture<Utils.ResultOfConvertAddress> convertAddress(int ctxId,
      String address, Utils.AddressStringFormat outputFormat) throws TvmSdkException {
    return TvmSdk.async(ctxId, "utils.convert_address", new Utils.ParamsOfConvertAddress(address, outputFormat), Utils.ResultOfConvertAddress.class);
  }
  ...
  public static CompletableFuture<Utils.ResultOfGetAddressType> getAddressType(int ctxId,
    ...
    return TvmSdk.async(ctxId, "utils.get_address_type", new Utils.ParamsOfGetAddressType(address), Utils.ResultOfGetAddressType.class);
  }
  ...
  public static CompletableFuture<Utils.ResultOfCalcStorageFee> calcStorageFee(int ctxId,
      String account, Long period) throws TvmSdkException {
    return TvmSdk.async(ctxId, "utils.calc_storage_fee", new Utils.ParamsOfCalcStorageFee(account, period), Utils.ResultOfCalcStorageFee.class);
  }
  ...
  public static CompletableFuture<Utils.ResultOfCompressZstd> compressZstd(int ctxId,
      String uncompressed, Long level) throws TvmSdkException {
    return TvmSdk.async(ctxId, "utils.compress_zstd", new Utils.ParamsOfCompressZstd(uncompressed, level), Utils.ResultOfCompressZstd.class);
  }
  ...
  public static CompletableFuture<Utils.ResultOfDecompressZstd> decompressZstd(int ctxId,
      String compressed) throws TvmSdkException {
    return TvmSdk.async(ctxId, "utils.decompress_zstd", new Utils.ParamsOfDecompressZstd(compressed), Utils.ResultOfDecompressZstd.class);
  }
