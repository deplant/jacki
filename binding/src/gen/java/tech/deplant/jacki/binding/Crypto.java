...
public final class Crypto {
  ...
  public static CompletableFuture<Crypto.ResultOfFactorize> factorize(int ctxId, String composite)
      throws TvmSdkException {
    return TvmSdk.async(ctxId, "crypto.factorize", new Crypto.ParamsOfFactorize(composite), Crypto.ResultOfFactorize.class);
  }
  ...
  public static CompletableFuture<Crypto.ResultOfModularPower> modularPower(int ctxId, String base,
      String exponent, String modulus) throws TvmSdkException {
    return TvmSdk.async(ctxId, "crypto.modular_power", new Crypto.ParamsOfModularPower(base, exponent, modulus), Crypto.ResultOfModularPower.class);
  }
  ...
  public static CompletableFuture<Crypto.ResultOfTonCrc16> tonCrc16(int ctxId, String data) throws
          TvmSdkException {
    return TvmSdk.async(ctxId, "crypto.ton_crc16", new Crypto.ParamsOfTonCrc16(data), Crypto.ResultOfTonCrc16.class);
  }
  ...
  public static CompletableFuture<Crypto.ResultOfGenerateRandomBytes> generateRandomBytes(int ctxId,
      Long length) throws TvmSdkException {
    return TvmSdk.async(ctxId, "crypto.generate_random_bytes", new Crypto.ParamsOfGenerateRandomBytes(length), Crypto.ResultOfGenerateRandomBytes.class);
  }
  ...
  public static CompletableFuture<Crypto.ResultOfConvertPublicKeyToTonSafeFormat> convertPublicKeyToTonSafeFormat(
      int ctxId, String publicKey) throws TvmSdkException {
    return TvmSdk.async(ctxId, "crypto.convert_public_key_to_ton_safe_format", new Crypto.ParamsOfConvertPublicKeyToTonSafeFormat(publicKey), Crypto.ResultOfConvertPublicKeyToTonSafeFormat.class);
  }
  ...
  public static CompletableFuture<Crypto.KeyPair> generateRandomSignKeys(int ctxId) throws
          TvmSdkException {
    return TvmSdk.async(ctxId, "crypto.generate_random_sign_keys", null, Crypto.KeyPair.class);
  }
  ...
  public static CompletableFuture<Crypto.ResultOfSign> sign(int ctxId, String unsigned,
      Crypto.KeyPair keys) throws TvmSdkException {
    return TvmSdk.async(ctxId, "crypto.sign", new Crypto.ParamsOfSign(unsigned, keys), Crypto.ResultOfSign.class);
  }
  ...
  public static CompletableFuture<Crypto.ResultOfVerifySignature> verifySignature(int ctxId,
      String signed, @JsonProperty("public") String publicKey) throws TvmSdkException {
    return TvmSdk.async(ctxId, "crypto.verify_signature", new Crypto.ParamsOfVerifySignature(signed, publicKey), Crypto.ResultOfVerifySignature.class);
  }
  ...
  public static CompletableFuture<Crypto.ResultOfHash> sha256(int ctxId, String data) throws
          TvmSdkException {
    return TvmSdk.async(ctxId, "crypto.sha256", new Crypto.ParamsOfHash(data), Crypto.ResultOfHash.class);
  }
  ...
  public static CompletableFuture<Crypto.ResultOfHash> sha512(int ctxId, String data) throws
          TvmSdkException {
    return TvmSdk.async(ctxId, "crypto.sha512", new Crypto.ParamsOfHash(data), Crypto.ResultOfHash.class);
  }
  ...
  public static CompletableFuture<Crypto.ResultOfScrypt> scrypt(int ctxId, String password,
      String salt, Integer logN, Long r, Long p, Long dkLen) throws TvmSdkException {
    return TvmSdk.async(ctxId, "crypto.scrypt", new Crypto.ParamsOfScrypt(password, salt, logN, r, p, dkLen), Crypto.ResultOfScrypt.class);
  }
  ...
  public static CompletableFuture<Crypto.KeyPair> naclSignKeypairFromSecretKey(int ctxId,
      @JsonProperty("secret") String secretKey) throws TvmSdkException {
    return TvmSdk.async(ctxId, "crypto.nacl_sign_keypair_from_secret_key", new Crypto.ParamsOfNaclSignKeyPairFromSecret(secretKey), Crypto.KeyPair.class);
  }
  ...
  public static CompletableFuture<Crypto.ResultOfNaclSign> naclSign(int ctxId, String unsigned,
      @JsonProperty("secret") String secretKey) throws TvmSdkException {
    return TvmSdk.async(ctxId, "crypto.nacl_sign", new Crypto.ParamsOfNaclSign(unsigned, secretKey), Crypto.ResultOfNaclSign.class);
  }
  ...
  public static CompletableFuture<Crypto.ResultOfNaclSignOpen> naclSignOpen(int ctxId,
      String signed, @JsonProperty("public") String publicKey) throws TvmSdkException {
    return TvmSdk.async(ctxId, "crypto.nacl_sign_open", new Crypto.ParamsOfNaclSignOpen(signed, publicKey), Crypto.ResultOfNaclSignOpen.class);
  }
  ...
  public static CompletableFuture<Crypto.ResultOfNaclSignDetached> naclSignDetached(int ctxId,
      String unsigned, @JsonProperty("secret") String secretKey) throws TvmSdkException {
    return TvmSdk.async(ctxId, "crypto.nacl_sign_detached", new Crypto.ParamsOfNaclSign(unsigned, secretKey), Crypto.ResultOfNaclSignDetached.class);
  }
  ...
  public static CompletableFuture<Crypto.ResultOfNaclSignDetachedVerify> naclSignDetachedVerify(
      int ctxId, String unsigned, String signature, @JsonProperty("public") String publicKey) throws
          TvmSdkException {
    return TvmSdk.async(ctxId, "crypto.nacl_sign_detached_verify", new Crypto.ParamsOfNaclSignDetachedVerify(unsigned, signature, publicKey), Crypto.ResultOfNaclSignDetachedVerify.class);
  }
  ...
  public static CompletableFuture<Crypto.KeyPair> naclBoxKeypair(int ctxId) throws
          TvmSdkException {
    return TvmSdk.async(ctxId, "crypto.nacl_box_keypair", null, Crypto.KeyPair.class);
  }
  ...
  public static CompletableFuture<Crypto.KeyPair> naclBoxKeypairFromSecretKey(int ctxId,
      @JsonProperty("secret") String secretKey) throws TvmSdkException {
    return TvmSdk.async(ctxId, "crypto.nacl_box_keypair_from_secret_key", new Crypto.ParamsOfNaclBoxKeyPairFromSecret(secretKey), Crypto.KeyPair.class);
  }
  ...
  public static CompletableFuture<Crypto.ResultOfNaclBox> naclBox(int ctxId, String decrypted,
      String nonce, String theirPublic, @JsonProperty("secret") String secretKey) throws
          TvmSdkException {
    return TvmSdk.async(ctxId, "crypto.nacl_box", new Crypto.ParamsOfNaclBox(decrypted, nonce, theirPublic, secretKey), Crypto.ResultOfNaclBox.class);
  }
  ...
  public static CompletableFuture<Crypto.ResultOfNaclBoxOpen> naclBoxOpen(int ctxId,
      ...
      throws TvmSdkException {
    return TvmSdk.async(ctxId, "crypto.nacl_box_open", new Crypto.ParamsOfNaclBoxOpen(encrypted, nonce, theirPublic, secretKey), Crypto.ResultOfNaclBoxOpen.class);
  }
  ...
  public static CompletableFuture<Crypto.ResultOfNaclBox> naclSecretBox(int ctxId, String decrypted,
      String nonce, String key) throws TvmSdkException {
    return TvmSdk.async(ctxId, "crypto.nacl_secret_box", new Crypto.ParamsOfNaclSecretBox(decrypted, nonce, key), Crypto.ResultOfNaclBox.class);
  }
  ...
  public static CompletableFuture<Crypto.ResultOfNaclBoxOpen> naclSecretBoxOpen(int ctxId,
      String encrypted, String nonce, String key) throws TvmSdkException {
    return TvmSdk.async(ctxId, "crypto.nacl_secret_box_open", new Crypto.ParamsOfNaclSecretBoxOpen(encrypted, nonce, key), Crypto.ResultOfNaclBoxOpen.class);
  }
  ...
  public static CompletableFuture<Crypto.ResultOfMnemonicWords> mnemonicWords(int ctxId,
    ...
    return TvmSdk.async(ctxId, "crypto.mnemonic_words", new Crypto.ParamsOfMnemonicWords(dictionary), Crypto.ResultOfMnemonicWords.class);
  }
  ...
  public static CompletableFuture<Crypto.ResultOfMnemonicFromRandom> mnemonicFromRandom(int ctxId,
      Crypto.MnemonicDictionary dictionary, Integer wordCount) throws TvmSdkException {
    return TvmSdk.async(ctxId, "crypto.mnemonic_from_random", new Crypto.ParamsOfMnemonicFromRandom(dictionary, wordCount), Crypto.ResultOfMnemonicFromRandom.class);
  }
  ...
  public static CompletableFuture<Crypto.ResultOfMnemonicFromEntropy> mnemonicFromEntropy(int ctxId,
      String entropy, Crypto.MnemonicDictionary dictionary, Integer wordCount) throws
          TvmSdkException {
    return TvmSdk.async(ctxId, "crypto.mnemonic_from_entropy", new Crypto.ParamsOfMnemonicFromEntropy(entropy, dictionary, wordCount), Crypto.ResultOfMnemonicFromEntropy.class);
  }
  ...
  public static CompletableFuture<Crypto.ResultOfMnemonicVerify> mnemonicVerify(int ctxId,
      String phrase, Crypto.MnemonicDictionary dictionary, Integer wordCount) throws
          TvmSdkException {
    return TvmSdk.async(ctxId, "crypto.mnemonic_verify", new Crypto.ParamsOfMnemonicVerify(phrase, dictionary, wordCount), Crypto.ResultOfMnemonicVerify.class);
  }
  ...
  public static CompletableFuture<Crypto.KeyPair> mnemonicDeriveSignKeys(int ctxId, String phrase,
      String path, Crypto.MnemonicDictionary dictionary, Integer wordCount) throws
          TvmSdkException {
    return TvmSdk.async(ctxId, "crypto.mnemonic_derive_sign_keys", new Crypto.ParamsOfMnemonicDeriveSignKeys(phrase, path, dictionary, wordCount), Crypto.KeyPair.class);
  }
  ...
  public static CompletableFuture<Crypto.ResultOfHDKeyXPrvFromMnemonic> hdkeyXprvFromMnemonic(
      int ctxId, String phrase, Crypto.MnemonicDictionary dictionary, Integer wordCount) throws
          TvmSdkException {
    return TvmSdk.async(ctxId, "crypto.hdkey_xprv_from_mnemonic", new Crypto.ParamsOfHDKeyXPrvFromMnemonic(phrase, dictionary, wordCount), Crypto.ResultOfHDKeyXPrvFromMnemonic.class);
  }
  ...
  public static CompletableFuture<Crypto.ResultOfHDKeyDeriveFromXPrv> hdkeyDeriveFromXprv(int ctxId,
      String xprv, Long childIndex, Boolean hardened) throws TvmSdkException {
    return TvmSdk.async(ctxId, "crypto.hdkey_derive_from_xprv", new Crypto.ParamsOfHDKeyDeriveFromXPrv(xprv, childIndex, hardened), Crypto.ResultOfHDKeyDeriveFromXPrv.class);
  }
  ...
  public static CompletableFuture<Crypto.ResultOfHDKeyDeriveFromXPrvPath> hdkeyDeriveFromXprvPath(
      int ctxId, String xprv, String path) throws TvmSdkException {
    return TvmSdk.async(ctxId, "crypto.hdkey_derive_from_xprv_path", new Crypto.ParamsOfHDKeyDeriveFromXPrvPath(xprv, path), Crypto.ResultOfHDKeyDeriveFromXPrvPath.class);
  }
  ...
  public static CompletableFuture<Crypto.ResultOfHDKeySecretFromXPrv> hdkeySecretFromXprv(int ctxId,
      String xprv) throws TvmSdkException {
    return TvmSdk.async(ctxId, "crypto.hdkey_secret_from_xprv", new Crypto.ParamsOfHDKeySecretFromXPrv(xprv), Crypto.ResultOfHDKeySecretFromXPrv.class);
  }
  ...
  public static CompletableFuture<Crypto.ResultOfHDKeyPublicFromXPrv> hdkeyPublicFromXprv(int ctxId,
      String xprv) throws TvmSdkException {
    return TvmSdk.async(ctxId, "crypto.hdkey_public_from_xprv", new Crypto.ParamsOfHDKeyPublicFromXPrv(xprv), Crypto.ResultOfHDKeyPublicFromXPrv.class);
  }
  ...
  public static CompletableFuture<Crypto.ResultOfChaCha20> chacha20(int ctxId, String data,
      String key, String nonce) throws TvmSdkException {
    return TvmSdk.async(ctxId, "crypto.chacha20", new Crypto.ParamsOfChaCha20(data, key, nonce), Crypto.ResultOfChaCha20.class);
  }
  ...
  public static CompletableFuture<Crypto.RegisteredCryptoBox> createCryptoBox(int ctxId,
      ...
      AppPasswordProvider appObject) throws TvmSdkException {
    return TvmSdk.asyncAppObject(ctxId, "crypto.create_crypto_box", new Crypto.ParamsOfCreateCryptoBox(secretEncryptionSalt, secretKey), Crypto.RegisteredCryptoBox.class, appObject);
  }
  ...
  public static void removeCryptoBox(int ctxId, Crypto.RegisteredCryptoBox params) throws
          TvmSdkException {
    TvmSdk.asyncVoid(ctxId, "crypto.remove_crypto_box", params);
  }
  ...
  public static CompletableFuture<Crypto.ResultOfGetCryptoBoxInfo> getCryptoBoxInfo(int ctxId,
      Crypto.RegisteredCryptoBox params) throws TvmSdkException {
    return TvmSdk.async(ctxId, "crypto.get_crypto_box_info", params, Crypto.ResultOfGetCryptoBoxInfo.class);
  }
  ...
  public static CompletableFuture<Crypto.ResultOfGetCryptoBoxSeedPhrase> getCryptoBoxSeedPhrase(
      int ctxId, Crypto.RegisteredCryptoBox params) throws TvmSdkException {
    return TvmSdk.async(ctxId, "crypto.get_crypto_box_seed_phrase", params, Crypto.ResultOfGetCryptoBoxSeedPhrase.class);
  }
  ...
  public static CompletableFuture<Crypto.RegisteredSigningBox> getSigningBoxFromCryptoBox(int ctxId,
      Long handle, String hdpath, Long secretLifetime) throws TvmSdkException {
    return TvmSdk.async(ctxId, "crypto.get_signing_box_from_crypto_box", new Crypto.ParamsOfGetSigningBoxFromCryptoBox(handle, hdpath, secretLifetime), Crypto.RegisteredSigningBox.class);
  }
  ...
  public static CompletableFuture<Crypto.RegisteredEncryptionBox> getEncryptionBoxFromCryptoBox(
      ...
      Long secretLifetime) throws TvmSdkException {
    return TvmSdk.async(ctxId, "crypto.get_encryption_box_from_crypto_box", new Crypto.ParamsOfGetEncryptionBoxFromCryptoBox(handle, hdpath, algorithm, secretLifetime), Crypto.RegisteredEncryptionBox.class);
  }
  ...
  public static void clearCryptoBoxSecretCache(int ctxId, Crypto.RegisteredCryptoBox params) throws
          TvmSdkException {
    TvmSdk.asyncVoid(ctxId, "crypto.clear_crypto_box_secret_cache", params);
  }
  ...
  public static CompletableFuture<Crypto.RegisteredSigningBox> registerSigningBox(int ctxId,
      AppSigningBox appObject) throws TvmSdkException {
    return TvmSdk.asyncAppObject(ctxId, "crypto.register_signing_box", null, Crypto.RegisteredSigningBox.class, appObject);
  }
  ...
  public static CompletableFuture<Crypto.RegisteredSigningBox> getSigningBox(int ctxId,
      Crypto.KeyPair params) throws TvmSdkException {
    return TvmSdk.async(ctxId, "crypto.get_signing_box", params, Crypto.RegisteredSigningBox.class);
  }
  ...
  public static CompletableFuture<Crypto.ResultOfSigningBoxGetPublicKey> signingBoxGetPublicKey(
      int ctxId, Crypto.RegisteredSigningBox params) throws TvmSdkException {
    return TvmSdk.async(ctxId, "crypto.signing_box_get_public_key", params, Crypto.ResultOfSigningBoxGetPublicKey.class);
  }
  ...
  public static CompletableFuture<Crypto.ResultOfSigningBoxSign> signingBoxSign(int ctxId,
      Long signingBox, String unsigned) throws TvmSdkException {
    return TvmSdk.async(ctxId, "crypto.signing_box_sign", new Crypto.ParamsOfSigningBoxSign(signingBox, unsigned), Crypto.ResultOfSigningBoxSign.class);
  }
  ...
  public static void removeSigningBox(int ctxId, Crypto.RegisteredSigningBox params) throws
          TvmSdkException {
    TvmSdk.asyncVoid(ctxId, "crypto.remove_signing_box", params);
  }
  ...
  public static CompletableFuture<Crypto.RegisteredEncryptionBox> registerEncryptionBox(int ctxId,
      AppEncryptionBox appObject) throws TvmSdkException {
    return TvmSdk.asyncAppObject(ctxId, "crypto.register_encryption_box", null, Crypto.RegisteredEncryptionBox.class, appObject);
  }
  ...
  public static void removeEncryptionBox(int ctxId, Crypto.RegisteredEncryptionBox params) throws
          TvmSdkException {
    TvmSdk.asyncVoid(ctxId, "crypto.remove_encryption_box", params);
  }
  ...
  public static CompletableFuture<Crypto.ResultOfEncryptionBoxGetInfo> encryptionBoxGetInfo(
      int ctxId, Long encryptionBox) throws TvmSdkException {
    return TvmSdk.async(ctxId, "crypto.encryption_box_get_info", new Crypto.ParamsOfEncryptionBoxGetInfo(encryptionBox), Crypto.ResultOfEncryptionBoxGetInfo.class);
  }
  ...
  public static CompletableFuture<Crypto.ResultOfEncryptionBoxEncrypt> encryptionBoxEncrypt(
      int ctxId, Long encryptionBox, String data) throws TvmSdkException {
    return TvmSdk.async(ctxId, "crypto.encryption_box_encrypt", new Crypto.ParamsOfEncryptionBoxEncrypt(encryptionBox, data), Crypto.ResultOfEncryptionBoxEncrypt.class);
  }
  ...
  public static CompletableFuture<Crypto.ResultOfEncryptionBoxDecrypt> encryptionBoxDecrypt(
      int ctxId, Long encryptionBox, String data) throws TvmSdkException {
    return TvmSdk.async(ctxId, "crypto.encryption_box_decrypt", new Crypto.ParamsOfEncryptionBoxDecrypt(encryptionBox, data), Crypto.ResultOfEncryptionBoxDecrypt.class);
  }
  ...
  public static CompletableFuture<Crypto.RegisteredEncryptionBox> createEncryptionBox(int ctxId,
      Crypto.EncryptionAlgorithm algorithm) throws TvmSdkException {
    return TvmSdk.async(ctxId, "crypto.create_encryption_box", new Crypto.ParamsOfCreateEncryptionBox(algorithm), Crypto.RegisteredEncryptionBox.class);
  }
