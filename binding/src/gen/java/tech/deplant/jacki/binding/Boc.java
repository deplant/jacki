...
public final class Boc {
  ...
  public static CompletableFuture<Boc.ResultOfDecodeTvc> decodeTvc(int ctxId, String tvc) throws
          TvmSdkException {
    return TvmSdk.async(ctxId, "boc.decode_tvc", new Boc.ParamsOfDecodeTvc(tvc), Boc.ResultOfDecodeTvc.class);
  }
  ...
  public static CompletableFuture<Boc.ResultOfParse> parseMessage(int ctxId, String boc) throws
          TvmSdkException {
    return TvmSdk.async(ctxId, "boc.parse_message", new Boc.ParamsOfParse(boc), Boc.ResultOfParse.class);
  }
  ...
  public static CompletableFuture<Boc.ResultOfParse> parseTransaction(int ctxId, String boc) throws
          TvmSdkException {
    return TvmSdk.async(ctxId, "boc.parse_transaction", new Boc.ParamsOfParse(boc), Boc.ResultOfParse.class);
  }
  ...
  public static CompletableFuture<Boc.ResultOfParse> parseAccount(int ctxId, String boc) throws
          TvmSdkException {
    return TvmSdk.async(ctxId, "boc.parse_account", new Boc.ParamsOfParse(boc), Boc.ResultOfParse.class);
  }
  ...
  public static CompletableFuture<Boc.ResultOfParse> parseBlock(int ctxId, String boc) throws
          TvmSdkException {
    return TvmSdk.async(ctxId, "boc.parse_block", new Boc.ParamsOfParse(boc), Boc.ResultOfParse.class);
  }
  ...
  public static CompletableFuture<Boc.ResultOfParse> parseShardstate(int ctxId, String boc,
      String id, Long workchainId) throws TvmSdkException {
    return TvmSdk.async(ctxId, "boc.parse_shardstate", new Boc.ParamsOfParseShardstate(boc, id, workchainId), Boc.ResultOfParse.class);
  }
  ...
  public static CompletableFuture<Boc.ResultOfGetBlockchainConfig> getBlockchainConfig(int ctxId,
      String blockBoc) throws TvmSdkException {
    return TvmSdk.async(ctxId, "boc.get_blockchain_config", new Boc.ParamsOfGetBlockchainConfig(blockBoc), Boc.ResultOfGetBlockchainConfig.class);
  }
  ...
  public static CompletableFuture<Boc.ResultOfGetBocHash> getBocHash(int ctxId, String boc) throws
          TvmSdkException {
    return TvmSdk.async(ctxId, "boc.get_boc_hash", new Boc.ParamsOfGetBocHash(boc), Boc.ResultOfGetBocHash.class);
  }
  ...
  public static CompletableFuture<Boc.ResultOfGetBocDepth> getBocDepth(int ctxId, String boc) throws
          TvmSdkException {
    return TvmSdk.async(ctxId, "boc.get_boc_depth", new Boc.ParamsOfGetBocDepth(boc), Boc.ResultOfGetBocDepth.class);
  }
  ...
  public static CompletableFuture<Boc.ResultOfGetCodeFromTvc> getCodeFromTvc(int ctxId, String tvc)
    ...
    return TvmSdk.async(ctxId, "boc.get_code_from_tvc", new Boc.ParamsOfGetCodeFromTvc(tvc), Boc.ResultOfGetCodeFromTvc.class);
  }
  ...
  public static CompletableFuture<Boc.ResultOfBocCacheGet> cacheGet(int ctxId, String bocRef) throws
          TvmSdkException {
    return TvmSdk.async(ctxId, "boc.cache_get", new Boc.ParamsOfBocCacheGet(bocRef), Boc.ResultOfBocCacheGet.class);
  }
  ...
  public static CompletableFuture<Boc.ResultOfBocCacheSet> cacheSet(int ctxId, String boc,
      Boc.BocCacheType cacheType) throws TvmSdkException {
    return TvmSdk.async(ctxId, "boc.cache_set", new Boc.ParamsOfBocCacheSet(boc, cacheType), Boc.ResultOfBocCacheSet.class);
  }
   ...
   */
  public static void cacheUnpin(int ctxId, String pin, String bocRef) throws TvmSdkException {
    TvmSdk.asyncVoid(ctxId, "boc.cache_unpin", new Boc.ParamsOfBocCacheUnpin(pin, bocRef));
  }
  ...
  public static CompletableFuture<Boc.ResultOfEncodeBoc> encodeBoc(int ctxId,
      Boc.BuilderOp[] builder, Boc.BocCacheType bocCache) throws TvmSdkException {
    return TvmSdk.async(ctxId, "boc.encode_boc", new Boc.ParamsOfEncodeBoc(builder, bocCache), Boc.ResultOfEncodeBoc.class);
  }
  ...
  public static CompletableFuture<Boc.ResultOfGetCodeSalt> getCodeSalt(int ctxId, String code,
    ...
    return TvmSdk.async(ctxId, "boc.get_code_salt", new Boc.ParamsOfGetCodeSalt(code, bocCache), Boc.ResultOfGetCodeSalt.class);
  }
  ...
  public static CompletableFuture<Boc.ResultOfSetCodeSalt> setCodeSalt(int ctxId, String code,
      String salt, Boc.BocCacheType bocCache) throws TvmSdkException {
    return TvmSdk.async(ctxId, "boc.set_code_salt", new Boc.ParamsOfSetCodeSalt(code, salt, bocCache), Boc.ResultOfSetCodeSalt.class);
  }
  ...
  public static CompletableFuture<Boc.ResultOfDecodeStateInit> decodeStateInit(int ctxId,
      String stateInit, Boc.BocCacheType bocCache) throws TvmSdkException {
    return TvmSdk.async(ctxId, "boc.decode_state_init", new Boc.ParamsOfDecodeStateInit(stateInit, bocCache), Boc.ResultOfDecodeStateInit.class);
  }
  ...
  public static CompletableFuture<Boc.ResultOfEncodeStateInit> encodeStateInit(int ctxId,
      ...
      Boc.BocCacheType bocCache) throws TvmSdkException {
    return TvmSdk.async(ctxId, "boc.encode_state_init", new Boc.ParamsOfEncodeStateInit(code, data, library, tick, tock, splitDepth, bocCache), Boc.ResultOfEncodeStateInit.class);
  }
  ...
  public static CompletableFuture<Boc.ResultOfEncodeExternalInMessage> encodeExternalInMessage(
      int ctxId, String src, String dst, String init, String body, Boc.BocCacheType bocCache) throws
          TvmSdkException {
    return TvmSdk.async(ctxId, "boc.encode_external_in_message", new Boc.ParamsOfEncodeExternalInMessage(src, dst, init, body, bocCache), Boc.ResultOfEncodeExternalInMessage.class);
  }
  ...
  public static CompletableFuture<Boc.ResultOfGetCompilerVersion> getCompilerVersion(int ctxId,
      String code) throws TvmSdkException {
    return TvmSdk.async(ctxId, "boc.get_compiler_version", new Boc.ParamsOfGetCompilerVersion(code), Boc.ResultOfGetCompilerVersion.class);
  }
